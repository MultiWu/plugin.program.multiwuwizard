...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR red][B]MultiWu [/B][/COLOR]Wizard'
...
THEME1 = '[COLOR '+COLOR1+'][I]([COLOR '+COLOR1+'][B]MultiWu[/B][/COLOR][COLOR ' + COLOR2 + ']Wizard[COLOR ' + COLOR1 + '])[/I][/COLOR] [COLOR '+COLOR2+']{0}[/COLOR]'
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing MultiWu Wizard.\n\nContact us on Github at https://github.com/MultiWu/plugin.program.multiwuwizard/'
...
REPOID = 'repository.multiwu'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'https://raw.githubusercontent.com/MultiWu/repository.multiwu/master/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://raw.githubusercontent.com/MultiWu/repository.multiwu/master/zips/repository.openwizard/'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR red][B]MultiWu [/B][/COLOR]Wizard'
